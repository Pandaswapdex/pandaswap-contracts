...
// BambooRoll helps your migrate your existing Uniswap LP tokens to PandaSwap LP ones
contract BambooRoll {
    ...
    function migrate(
        ...
        require(deadline >= block.timestamp, 'PandaSwap: EXPIRED');
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'BambooRoll: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'BambooRoll: INSUFFICIENT_B_AMOUNT');
    }
